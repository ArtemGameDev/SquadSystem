...
concommand.Add("SquadLeaderBecome", function(ply)
    ...
    ply:SetNWEntity("SquadMemberAcceptance", "No")
    ...
    lbl:SetPos(11, 136)
    lbl:SetSize(128, 72)
    lbl:SetText("Ти став командиром загіну!")
...
concommand.Add("SquadMenuLeave", function(ply)
    if ply:GetNWEntity("SquadLeader") == ply then
        ...
        for k,v in pairs(player.GetAll()) do
            if v != ply then
                if (v:GetNWEntity("SquadMember01") == ply:GetNWEntity("SquadMember01") == v) then
                    v:SetNWEntity("SquadMember01", NULL)
                end
                if (v:GetNWEntity("SquadMember02") == ply:GetNWEntity("SquadMember02") == v) then
                    v:SetNWEntity("SquadMember02", NULL)
                end
                if (v:GetNWEntity("SquadMember03") == ply:GetNWEntity("SquadMember03") == v) then
                    v:SetNWEntity("SquadMember03", NULL)
                end
                if (v:GetNWEntity("SquadMember04") == ply:GetNWEntity("SquadMember04") == v) then
                    v:SetNWEntity("SquadMember04", NULL)
                end
            end
        end
    ...
    if ply:GetNWEntity("SquadLeader") != ply then
        ...
        if ply:GetNWEntity("SquadMember01") == ply then
            ply:SetNWEntity("SquadMember01",NULL)
            for k,v in pairs(player.GetAll()) do
                if v != ply and v:GetNWEntity("SquadLeader") == v then
                    v:SetNWEntity("SquadMember01",NULL)
                end
            end
...
concommand.Add("SquadMemberAccept", function(ply)
    ply:SetNWEntity("SquadMemberAcceptance", "Yes")
...
concommand.Add("SquadMemberNoAccept", function(ply)
    ply:SetNWEntity("SquadMemberAcceptance", "No")
...
concommand.Add("SquadMemberAdd", function(ply)
    ...
    if Distance < 200 then
        if trEntity:GetClass() == "player" and (trEntity:GetNWEntity("SquadMember01") != trEntity and trEntity:GetNWEntity("SquadMember02") != trEntity and trEntity:GetNWEntity("SquadMember03") != trEntity and trEntity:GetNWEntity("SquadMember04") != trEntity) then
            
            if ply:GetNWEntity("SquadMember01") == NULL then
                
                ply:SetNWEntity("SquadMember01", trEntity)
            ...
            elseif ply:GetNWEntity("SquadMember02") == NULL then
                
                ply:SetNWEntity("SquadMember02", trEntity)
            ...
            elseif ply:GetNWEntity("SquadMember03") == NULL then
                
                ply:SetNWEntity("SquadMember03", trEntity)
            ...
            elseif ply:GetNWEntity("SquadMember04") == NULL then
                
                ply:SetNWEntity("SquadMember04", trEntity)
...
concommand.Add("SquadMenuRemove", function(ply)
    
    local trEntity = ply:GetEyeTrace().Entity
    local Distance = ply:EyePos():Distance(trEntity:GetPos())

    if Distance < 200 then
        if trEntity == ply:GetNWEntity("SquadMember01") then
            ply:SetNWEntity("SquadMember01", NULL)
            ...
            lbl:SetPos(11, 136)
            lbl:SetSize(128, 72)
            lbl:SetText("Ти видалив з загіну!")
            lbl:SetTextColor(Color(255, 200, 0))
            lbl:SetFont("GModNotify")
            lbl:SetWrap(true)
            NotifyPanel:AddItem(bg)
        ...
        if trEntity == ply:GetNWEntity("SquadMember02") then
            ply:SetNWEntity("SquadMember02", NULL)
        ...
        if trEntity == ply:GetNWEntity("SquadMember03") then
            ply:SetNWEntity("SquadMember03", NULL)
        ...
        if trEntity == ply:GetNWEntity("SquadMember04") then
            ply:SetNWEntity("SquadMember04", NULL)
