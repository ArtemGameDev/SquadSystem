...
net.Receive("MessageToClSquadInfo", function()
    Leader = net.ReadEntity(TargetPlayer)
end)

net.Receive("Message", function()
    LeaderSq = net.ReadEntity()
    print(LeaderSq:GetNWEntity("SquadMember01"))
end)

hook.Add("HUDPaint", "HUDSquad", function()

    if LocalPlayer():GetNWEntity("SquadMember01") != NULL or LocalPlayer():GetNWEntity("SquadMember02") != NULL or LocalPlayer():GetNWEntity("SquadMember03") != NULL or LocalPlayer():GetNWEntity("SquadMember04") != NULL then
